...
namespace HmsPlugin
{
    public class LeaderboardManager : MonoBehaviour
    {
        ...
        public static LeaderboardManager GetInstance(string name = "HMSGameManager") => GameObject.Find(name).GetComponent<LeaderboardManager>();
        ...
        public void SubmitScore(string leaderboardId, long score)
        {
            ...
            task.AddOnSuccessListener((scoreInfo) =>
            {
                ...
                Debug.Log("Submitted Score. PlayerId: " + scoreInfo.PlayerId);
            }).AddOnFailureListener((error) =>
            {
                OnSubmitScoreFailure?.Invoke(error);
                Debug.LogError("Could not Submit Score. Error : " + error.WrappedExceptionMessage + error.WrappedCauseMessage);
            });
        }
