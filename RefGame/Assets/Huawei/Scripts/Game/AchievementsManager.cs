...
namespace HmsPlugin
{
    ...
    {
        public static AchievementsManager GetInstance(string name = "HMSGameManager") => GameObject.Find(name).GetComponent<AchievementsManager>();
        ...
        public void GetAchievementsList()
        {
            ...
            }).AddOnFailureListener((exception) =>
            {
                ...
                Debug.Log(exception.WrappedExceptionMessage + exception.WrappedCauseMessage);
